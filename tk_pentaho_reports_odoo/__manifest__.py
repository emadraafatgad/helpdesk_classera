...
Outstanding
-----------
* ** THIS MODULE IS TESTED TO BE WORKING WITH SQL REPORTS ONLY IN VERSION 13 . **  
...
""",
    ...
    'assets': {
        'web.assets_backend': [
            # 'tk_pentaho_reports_odoo/static/src/js/pentaho/tk_report_action_manager.js',
            # 'tk_pentaho_reports_odoo/static/src/js/pentaho/qwebactionmanager.js',
            # 'tk_pentaho_reports_odoo/static/src/js/pentaho/tk_action_manager.js',
            # 'tk_pentaho_reports_odoo/static/src/js/pentaho/action_service.js',
            'tk_pentaho_reports_odoo/static/src/js/pentaho/action_service.js',
        ],
    },
}